...
#define  ABOUT_TXTSOFT                    3       /* control type: textMsg, callback function: TxtSoftwareCallback */
#define  ABOUT_TXTHARD                    4       /* control type: textMsg, callback function: TxtHardwareCallback */
#define  ABOUT_UPDATESOFT                 5       /* control type: picture, callback function: (none) */
#define  ABOUT_UPDATEHARD                 6       /* control type: picture, callback function: (none) */
#define  ABOUT_PROGRESSBAR                7       /* control type: scale, callback function: (none) */
#define  ABOUT_FILEDIS_TEXTMSG            8       /* control type: textMsg, callback function: (none) */
#define  ABOUT_TEXTMSG                    9       /* control type: textMsg, callback function: (none) */
#define  ABOUT_HARDWAREVERSION            10      /* control type: textMsg, callback function: (none) */
#define  ABOUT_SOFTWAREVERSION            11      /* control type: textMsg, callback function: (none) */
#define  ABOUT_FIRMWAREVERSION            12      /* control type: textMsg, callback function: (none) */
#define  ABOUT_TESTWAREVERSION            13      /* control type: textMsg, callback function: (none) */
#define  ABOUT_NUM_HV                     14      /* control type: textMsg, callback function: (none) */
#define  ABOUT_NUM_FV                     15      /* control type: textMsg, callback function: (none) */
#define  ABOUT_NUM_SV                     16      /* control type: textMsg, callback function: (none) */
#define  ABOUT_LED                        17      /* control type: LED, callback function: LedCB */
#define  ABOUT_NUM_TV                     18      /* control type: textMsg, callback function: (none) */
